...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return parseDom; });
...
var components_PreviewVodComponent = __webpack_require__(18);
...
var src_components_PreviewVodComponent = __webpack_require__(46);
...
class PreviewVodComponent_PreviewVodComponent {
  ...
  constructor(previewDuration, previewEndHtml = null, previewBarHtml = null) {
    ...
    this.html = Object(utils["b" /* parseDom */])(PreviewVodComponent_default.a);
...
var components_BulletScreenComponent = __webpack_require__(9);
...
var src_components_BulletScreenComponent = __webpack_require__(34);
...
class BulletScreenComponent_BulletScreenComponent {
  ...
  constructor(text, style, bulletPosition = 'random') {
    ...
    this.html = Object(utils["b" /* parseDom */])(BulletScreenComponent_default.a);
...
// EXTERNAL MODULE: ./src/components/CaptionComponent/index.html
var components_CaptionComponent = __webpack_require__(10);
var CaptionComponent_default = /*#__PURE__*/__webpack_require__.n(components_CaptionComponent);

// EXTERNAL MODULE: ./src/components/CaptionComponent/caption-modal.html
var caption_modal = __webpack_require__(11);
var caption_modal_default = /*#__PURE__*/__webpack_require__.n(caption_modal);

// EXTERNAL MODULE: ./src/components/CaptionComponent/index.scss
var src_components_CaptionComponent = __webpack_require__(36);

// EXTERNAL MODULE: ./src/utils/index.js
var utils = __webpack_require__(0);

// CONCATENATED MODULE: ./src/components/CaptionComponent/index.js
 ...
 * 字幕组件
 */
class CaptionComponent_CaptionComponent {
  /**
  ...
  constructor() {
    ...
    this.html = Object(utils["b" /* parseDom */])(CaptionComponent_default.a);
    this.modalHtml = Object(utils["b" /* parseDom */])(caption_modal_default.a);
...
// CONCATENATED MODULE: ./src/components/CaptionComponent/export.js


if (!window.AliPlayerComponent) {
  window.AliPlayerComponent = {};
}
window.AliPlayerComponent.CaptionComponent = CaptionComponent_CaptionComponent;
...
// EXTERNAL MODULE: ./src/components/ManyVideoADComponent/index.html
var ManyVideoADComponent = __webpack_require__(12);
var ManyVideoADComponent_default = /*#__PURE__*/__webpack_require__.n(ManyVideoADComponent);

// EXTERNAL MODULE: ./src/components/ManyVideoADComponent/index.scss
var components_ManyVideoADComponent = __webpack_require__(38);

// EXTERNAL MODULE: ./src/utils/index.js
var utils = __webpack_require__(0);

// EXTERNAL MODULE: ./src/components/ManyVideoADComponent/mbIndex.html
var mbIndex = __webpack_require__(13);
var mbIndex_default = /*#__PURE__*/__webpack_require__.n(mbIndex);

// EXTERNAL MODULE: ./node_modules/current-device/es/index.js
var es = __webpack_require__(3);

// CONCATENATED MODULE: ./src/components/ManyVideoADComponent/index.js
 ...
 * PC 多视频广告组件
 */
class ManyVideoADComponent_ManyVideoAdComponent {
  /** 
  ...
  constructor(adVideoSource, adCloseFunction, closeText = '关闭广告') {
    ...
    this.html = Object(utils["b" /* parseDom */])(ManyVideoADComponent_default.a);
 ...
 * 移动端多视频广告组件
 */
class ManyVideoADComponent_MbManyVideoAdComponent {
  /**
  ...
  constructor(adVideoSource, adCloseFunction, closeText = '关闭广告') {
    this.adVideoSource = adVideoSource;
    this.html = Object(utils["b" /* parseDom */])(mbIndex_default.a);
    this.adInterval = null;
    this.adCloseFunction = adCloseFunction;
    this.html.querySelector('.many-video-ad-close-text').innerText = closeText;
    this.adDuration = null; // 视频广告的时长, 用于倒计时, 
...
let defaultComponent = ManyVideoADComponent_ManyVideoAdComponent;

if (es["a" /* default */].mobile()) {
  defaultComponent = ManyVideoADComponent_MbManyVideoAdComponent;
}

/* harmony default export */ var src_components_ManyVideoADComponent = (defaultComponent);
// CONCATENATED MODULE: ./src/components/ManyVideoADComponent/export.js


if (!window.AliPlayerComponent) {
  window.AliPlayerComponent = {};
}
window.AliPlayerComponent.ManyVideoADComponent = src_components_ManyVideoADComponent;
...
var components_MemoryPlayComponent = __webpack_require__(14);
...
var src_components_MemoryPlayComponent = __webpack_require__(40);
...
class MemoryPlayComponent_MemoryPlayComponent {
  ...
  constructor(autoPlay = false, getTime, saveTimeFunction) {
    this.html = Object(utils["b" /* parseDom */])(MemoryPlayComponent_default.a);
...
var components_PauseADComponent = __webpack_require__(15);
...
var src_components_PauseADComponent = __webpack_require__(42);
...
class PauseADComponent_PauseADComponent {
  ...
  constructor(coverUrl, adUrl) {
    ...
    this.adUrl = adUrl;
    this.html = Object(utils["b" /* parseDom */])(PauseADComponent_default.a);
  }
...
var components_PlaylistComponent = __webpack_require__(16);
...
var src_components_PlaylistComponent = __webpack_require__(44);
...
class PlaylistComponent_PlaylistComponent {
  ...
  constructor(playlist) {
    this.controlHtml = Object(utils["b" /* parseDom */])(PlaylistComponent_default.a);
    this.listHtml = Object(utils["b" /* parseDom */])(list_default.a);
...
var components_AliplayerDanmuComponent = __webpack_require__(5);
...
var danmu_control = __webpack_require__(6);
var danmu_control_default = /*#__PURE__*/__webpack_require__.n(danmu_control);

// EXTERNAL MODULE: ./src/components/AliplayerDanmuComponent/danmu-input.html
var danmu_input = __webpack_require__(7);
var danmu_input_default = /*#__PURE__*/__webpack_require__.n(danmu_input);

// EXTERNAL MODULE: ./src/components/AliplayerDanmuComponent/index.scss
var src_components_AliplayerDanmuComponent = __webpack_require__(30);

// EXTERNAL MODULE: ./node_modules/comment-core-library/build/CommentCoreLibrary.js
var CommentCoreLibrary = __webpack_require__(8);
...
class AliplayerDanmuComponent_AliplayerDanmuComponent {
  ...
  constructor(danmukuList, sendEl = 'controlbar') {
    ...
    this.html = Object(utils["b" /* parseDom */])(AliplayerDanmuComponent_default.a);
    this.danmuControlHtml = Object(utils["b" /* parseDom */])(danmu_control_default.a);
    this.sendEl = sendEl;
    this.danmuInput = sendEl === null ? null : Object(utils["b" /* parseDom */])(danmu_input_default.a);
    this.CM = null;
...
var components_QualityComponent = __webpack_require__(19);
...
var quality_modal = __webpack_require__(20);
...
var src_components_QualityComponent = __webpack_require__(49);
...
class QualityComponent_QualityComponent {
  constructor(getQuality) {
    this.html = Object(utils["b" /* parseDom */])(QualityComponent_default.a);
    this.modalHtml = Object(utils["b" /* parseDom */])(quality_modal_default.a);
    this.hasCreated = false;
    this.definition = '';
...
var components_RateComponent = __webpack_require__(21);
...
var src_components_RateComponent = __webpack_require__(51);
...
class RateComponent_RateComponent {
   ...
   */
  constructor() {
    this.html = Object(utils["b" /* parseDom */])(RateComponent_default.a);
  }
...
var components_RotateMirrorComponent = __webpack_require__(22);
...
var src_components_RotateMirrorComponent = __webpack_require__(53);
...
class RotateMirrorComponent_RotateMirrorComponent {
   ...
   */
  constructor() {
    this.html = Object(utils["b" /* parseDom */])(RotateMirrorComponent_default.a);
  }
...
var components_StartADComponent = __webpack_require__(23);
...
var src_components_StartADComponent = __webpack_require__(55);
...
class StartADComponent_StartADComponent {
  ...
  constructor(coverUrl, adUrl, adDuration) {
    ...
    this.html = Object(utils["b" /* parseDom */])(StartADComponent_default.a);
  }
...
// EXTERNAL MODULE: ./src/components/TrackComponent/index.html
var components_TrackComponent = __webpack_require__(24);
var TrackComponent_default = /*#__PURE__*/__webpack_require__.n(components_TrackComponent);

// EXTERNAL MODULE: ./src/components/TrackComponent/track-modal.html
var track_modal = __webpack_require__(25);
var track_modal_default = /*#__PURE__*/__webpack_require__.n(track_modal);

// EXTERNAL MODULE: ./src/components/TrackComponent/index.scss
var src_components_TrackComponent = __webpack_require__(57);

// EXTERNAL MODULE: ./src/utils/index.js
var utils = __webpack_require__(0);

// CONCATENATED MODULE: ./src/components/TrackComponent/index.js
 ...
 * 音轨组件
 */
class TrackComponent_TrackComponent {
  /**
  ...
  constructor() {
    this.trackList = null;
    this.html = Object(utils["b" /* parseDom */])(TrackComponent_default.a);
    this.modalHtml = Object(utils["b" /* parseDom */])(track_modal_default.a);
    this.hasCreated = false;
    this.definition = '';
  }
...
// CONCATENATED MODULE: ./src/components/TrackComponent/export.js


if (!window.AliPlayerComponent) {
  window.AliPlayerComponent = {};
}
window.AliPlayerComponent.TrackComponent = TrackComponent_TrackComponent;
...
var VideoADComponent = __webpack_require__(26);
...
var components_VideoADComponent = __webpack_require__(59);

// EXTERNAL MODULE: ./src/utils/index.js
var utils = __webpack_require__(0);

// EXTERNAL MODULE: ./src/components/VideoADComponent/mbIndex.html
var mbIndex = __webpack_require__(27);
var mbIndex_default = /*#__PURE__*/__webpack_require__.n(mbIndex);
...
class VideoADComponent_VideoAdComponent {
  ...
  constructor(adVideoSource, adLink, adCloseFunction, closeText = '关闭广告') {
    this.adVideoSource = adVideoSource;
    this.adLink = adLink;
    this.html = Object(utils["b" /* parseDom */])(VideoADComponent_default.a);
    this.adInterval = null;
    this.adCloseFunction = adCloseFunction;
...
var components_playerNextComponent = __webpack_require__(28);
...
var src_components_playerNextComponent = __webpack_require__(61);
